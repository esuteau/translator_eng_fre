...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    # Debug
    #key_sorted = sorted(source_vocab_to_int.keys())
    #for key in key_sorted:
    #    print('{}: {}'.format(key, source_vocab_to_int[key]))
    #print(source_text)
...
def model_inputs():
    ...
    return input_ph, target_ph, learning_rate_ph, keep_prob_ph
...
def decoding_layer_train(encoder_state, dec_cell, dec_embed_input, sequence_length, decoding_scope,
    ...
    train_pred, _, _ = tf.contrib.seq2seq.dynamic_rnn_decoder(dec_cell_drop, train_decoder_fn, dec_embed_input,
...
def seq2seq_model(input_data, target_data, keep_prob, batch_size, sequence_length, source_vocab_size, target_vocab_size,
    ...
    # Encode using encoding layer
    enc_state = encoding_layer(enc_embed_input, rnn_size, num_layers, keep_prob)
    
    # Process Target data
    dec_input = process_decoding_input(target_data, target_vocab_to_int, batch_size)
    
    # Apply embedding to target data
